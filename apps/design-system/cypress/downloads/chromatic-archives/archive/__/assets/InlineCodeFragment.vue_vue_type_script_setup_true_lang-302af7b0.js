import { o as openBlock, j as createElementBlock, a as createBaseVNode, bz as getRunnerConfigFromWindow, bA as useToggle, m as computed, L as gql, bB as defineStore, i as ref, z as useRouter, ao as useMutation, bC as RunAllSpecsDocument, aQ as useQuery, bD as RunAllSpecsDataDocument, al as isRunMode, aN as RUN_ALL_SPECS_KEY, d as defineComponent, F as Fragment, D as renderList, n as normalizeClass, t as toDisplayString, X as createTextVNode, b as unref, bE as commonjsGlobal, aq as getDefaultExportFromCjs, C as watch, bF as _, P as useElementSize, bG as shallowRef, aP as lodashExports, c as createBlock, bH as Card, h as useI18n, bI as ScaffoldGeneratorStepOne_E2eExamplesDocument, B as onMounted, f as createVNode, E as normalizeStyle, w as withCtx, $ as _sfc_main$n, bc as StandardModalFooter, k as createCommentVNode, bJ as ShikiHighlight, bK as _sfc_main$o, s as __unplugin_components_0$5, bL as useVModels, bM as EmptyGenerator_MatchSpecFileDocument, bN as EmptyGenerator_GenerateSpecDocument, bO as whenever, r as resolveComponent, e as withModifiers, aD as Input, bt as __unplugin_components_1, bP as __unplugin_components_1$1, b0 as createStaticVNode, bQ as __unplugin_components_0$6, p as renderSlot, bR as _sfc_main$q, Y as withDirectives, Z as vModelText, M as isRef, _ as _export_sfc, bS as __unplugin_components_0$7, I as IconMagnifyingGlass, be as useDebounce, bT as debouncedWatch, bU as createSlots, ar as vShow, bV as __unplugin_components_0$8, bW as VueComponentGeneratorStepOne_GenerateSpecDocument, bX as VueComponentGeneratorStepOneDocument, bY as ComponentList_GetReactComponentsFromFileDocument, bZ as ReactComponentGeneratorStepOne_GenerateSpecDocument, b_ as ReactComponentGeneratorStepOneDocument, H as resolveDynamicComponent, b$ as not, c0 as DialogOverlay, aC as _sfc_main$s, A as useSpecStore, c1 as SpecFilter_SetPreferencesDocument } from "./index-660b7eaf.js";
import { _ as __unplugin_components_0$4, p as posixify, g as getPathForPlatform } from "./box-open_x48-8c0e3696.js";
import { _ as _sfc_main$p, b as _sfc_main$r } from "./SpecPatterns.vue_vue_type_script_setup_true_lang-f9fdfb91.js";
const _hoisted_1$m = {
  height: "1em",
  width: "1em",
...
function fuzzySortSpecs(specs, searchValue) {
  ...
  const fuzzySortResult = fuzzySort.go(normalizedSearchValue, specs, { keys: ["normalizedRelative", "normalizedBaseName"], allowTypo: false, threshold: -3e3 }).map((result) => {
...
function normalizeSpecValue(name) {
